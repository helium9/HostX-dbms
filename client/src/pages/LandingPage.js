    ...
    <>
      <div className="relative flex flex-col min-h-screen">
        ...
        <img className="absolute left-0 top-0 h-[200px] sm:w-3/4 sm:h-[250px] " src={wave}></img>
          ...
          <img src={person} className="w-[120px]  h-[128px] left-3/4 top-[100px] sm:w-1/8  md:top-[50px] md:h-[185px] lg:h-[280px] md:w-[20%] absolute"></img>
          <img src={slice} className="absolute w-1/8 h-[120px] top-[190px] sm:top-[230px] lg:top-[280px]  left-1/8 "></img>
          <img src={strip} className="absolute w-[30%] h-[180px] hidden md:block top-[180px] lg:top-[220px] lg:left-[40%]  left-1/2"></img>
          <img src={donut} className="absolute w-[15%] h-[100px] left-[85%] top-[400px] md:left-[90%] md:w-[10%] xl:top-[100px] xl:left-[95%] xl:w-[5%] "></img>
