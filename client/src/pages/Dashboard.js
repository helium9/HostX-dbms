...
export default function Dashboard() {
  return (
    <>
      <NavbarComponent />
      <div className="flex flex-col gap-5 p-7 font-['Poppins'] lg:flex-row lg:flex-wrap">
        <Card className="rounded-[12px] border-slate-800 border-2 lg:w-fit lg:py-8 lg:m-0">
        ...
        <Card className="rounded-[12px] border-slate-800 border-2 px-9 lg:w-fit lg:grow">
